        ...
        <div class="card">
            ...
            <div class="card-body mt-3">
                <div class=" card-title ms-2">
                    <h5 style="margin-bottom: 20px;">Data Barang Masuk</h5>
                </div>
                <div class="d-flex justify-content-end align-items-center mt-2">
                    <a href="{{ route('barang_masuk.tambah') }}" class="btn btn-success bi bi-plus-lg me-2">
                        Tambah Data
                    </a>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; align-items: center;">
                                        ...
                                        @endif
                                        <form action="{{ route('barang_masuk.hapus', $item->id) }}" method="POST"
